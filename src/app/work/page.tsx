...
const ACCENT: Record<string, { panel: string; dot: string; tagBg: string; tagBorder: string; glyph: string }> = {
  ...
  "welaspace": { panel: "linear-gradient(140deg,#0a1628,#1a2d50,#080e1a)", dot: "#38bdf8", tagBg: "rgba(56,189,248,0.15)", tagBorder: "rgba(56,189,248,0.3)", glyph: "WS" },
  "devflow-pro": { panel: "linear-gradient(140deg,#0f0a20,#231840,#0a0615)", dot: "#c084fc", tagBg: "rgba(192,132,252,0.15)", tagBorder: "rgba(192,132,252,0.3)", glyph: "DEV" },
  "ghostorganize-pro": { panel: "linear-gradient(140deg,#0a1a10,#183028,#050e08)", dot: "#34d399", tagBg: "rgba(52,211,153,0.15)", tagBorder: "rgba(52,211,153,0.3)", glyph: "GO" },
  ...
  "flutter-finance": { panel: "linear-gradient(140deg,#001a2e,#00344e,#001020)", dot: "#22d3ee", tagBg: "rgba(34,211,238,0.15)", tagBorder: "rgba(34,211,238,0.3)", glyph: "₣" },
