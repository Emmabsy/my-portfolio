...
const ACCENT: Record<string, { panel: string; dot: string; tagBg: string; tagBorder: string; glyph: string }> = {
  "resumepro":           { panel: "linear-gradient(140deg,#0c1a2e,#1a3a6e,#0a1020)", dot: "#60a5fa", tagBg: "rgba(96,165,250,0.15)",  tagBorder: "rgba(96,165,250,0.3)",  glyph: "ATS"  },
  "prompt-bible":        { panel: "linear-gradient(140deg,#1a0a2e,#2d1a5c,#0f0720)", dot: "#c084fc", tagBg: "rgba(192,132,252,0.15)", tagBorder: "rgba(192,132,252,0.3)", glyph: "AI"   },
  "launchkit":           { panel: "linear-gradient(140deg,#0a1628,#1a2d50,#080e1a)", dot: "#38bdf8", tagBg: "rgba(56,189,248,0.15)",  tagBorder: "rgba(56,189,248,0.3)",  glyph: "KIT"  },
  ...
  "welaspace":           { panel: "linear-gradient(140deg,#0a1a30,#162a4a,#060d18)", dot: "#34d399", tagBg: "rgba(52,211,153,0.15)",  tagBorder: "rgba(52,211,153,0.3)",  glyph: "WS"   },
  "devflow-pro":         { panel: "linear-gradient(140deg,#0f0a20,#231840,#0a0615)", dot: "#f472b6", tagBg: "rgba(244,114,182,0.15)", tagBorder: "rgba(244,114,182,0.3)", glyph: "DEV"  },
  "ghostorganize-pro":   { panel: "linear-gradient(140deg,#0a1a10,#183028,#050e08)", dot: "#4ade80", tagBg: "rgba(74,222,128,0.15)",  tagBorder: "rgba(74,222,128,0.3)",  glyph: "GO"   },
  "edu-platform":        { panel: "linear-gradient(140deg,#1a1000,#2d1f00,#120c00)", dot: "#fbbf24", tagBg: "rgba(251,191,36,0.15)",  tagBorder: "rgba(251,191,36,0.3)",  glyph: "EDU"  },
  "n8n-bundle":          { panel: "linear-gradient(140deg,#1a0a00,#3d1c00,#120600)", dot: "#fb923c", tagBg: "rgba(251,146,60,0.15)",  tagBorder: "rgba(251,146,60,0.3)",  glyph: "n8n"  },
  "n8n-upwork-proposal": { panel: "linear-gradient(140deg,#0a1400,#1e2e00,#060800)", dot: "#a3e635", tagBg: "rgba(163,230,53,0.15)",  tagBorder: "rgba(163,230,53,0.3)",  glyph: "UPW"  },
  "n8n-video-generator": { panel: "linear-gradient(140deg,#1a0010,#3a0028,#0d0008)", dot: "#f472b6", tagBg: "rgba(244,114,182,0.15)", tagBorder: "rgba(244,114,182,0.3)", glyph: "VID"  },
  "stockcard-twin":      { panel: "linear-gradient(140deg,#001a1a,#003434,#000d0d)", dot: "#22d3ee", tagBg: "rgba(34,211,238,0.15)",  tagBorder: "rgba(34,211,238,0.3)",  glyph: "DT"   },
  "nairobi-rush":        { panel: "linear-gradient(140deg,#1a0a00,#3a1a00,#0d0500)", dot: "#f97316", tagBg: "rgba(249,115,22,0.15)",  tagBorder: "rgba(249,115,22,0.3)",  glyph: "GAME" },
  "grid-defender":       { panel: "linear-gradient(140deg,#0a1a0a,#1a3a1a,#050d05)", dot: "#86efac", tagBg: "rgba(134,239,172,0.15)", tagBorder: "rgba(134,239,172,0.3)", glyph: "DEF"  },
  "void-drift":          { panel: "linear-gradient(140deg,#050510,#0f0f2e,#020208)", dot: "#818cf8", tagBg: "rgba(129,140,248,0.15)", tagBorder: "rgba(129,140,248,0.3)", glyph: "VOID" },
  "mac-toolbox":         { panel: "linear-gradient(140deg,#1a0a0a,#3a1010,#0d0404)", dot: "#f87171", tagBg: "rgba(248,113,113,0.15)", tagBorder: "rgba(248,113,113,0.3)", glyph: "MAC"  },
  ...
  "flutter-finance":     { panel: "linear-gradient(140deg,#001a2e,#00344e,#001020)", dot: "#22d3ee", tagBg: "rgba(34,211,238,0.15)",  tagBorder: "rgba(34,211,238,0.3)",  glyph: "FIN"  },
